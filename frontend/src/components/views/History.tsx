...
import { Clock, Dumbbell, Trash2, Weight, Heart, Activity, Timer, Flame, ChevronRight } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
              ...
              >
                <div className="p-5">
                  ...
                  <div className="flex flex-wrap gap-3 mb-3">
                    ...
                    {hasStrava && session.stravaActivities!.some(a => a.type !== 'WeightTraining') && (
                      <div className="flex items-center gap-1.5 text-muted-foreground">
        ...
        <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto rounded-2xl glass-surface border border-white/10 text-foreground">
          {selectedSession && (
            <>
              ...
              <div className="grid grid-cols-2 gap-2 mt-3">
                ...
                {selectedSession.durationMins && (
                  <div className="p-3 rounded-xl glass-surface border border-white/10">
                    ...
                    <p className="text-lg font-bold text-primary">
                      {formatDuration(selectedSession.durationMins)}
                    </p>
                  </div>
                )}
                ...
                {selectedSession.avgHeartRate && (
                  <div className="p-3 rounded-xl glass-surface border border-white/10">
                    ...
                    <p className="text-lg font-bold" style={{ color: 'hsl(0, 72%, 58%)' }}>
                      {Math.round(selectedSession.avgHeartRate)} <span className="text-xs font-medium text-muted-foreground">bpm</span>
                    </p>
                  </div>
                )}
              </div>
              ...
              {/* Strava Activities */}
              {selectedSession.stravaActivities && selectedSession.stravaActivities.length > 0 && (
                <div className="mt-4">
